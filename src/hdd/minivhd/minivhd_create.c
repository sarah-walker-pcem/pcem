...
MVHDMeta *mvhd_create_ex(MVHDCreationOptions options, int *err) {
        ...
        case MVHD_TYPE_DYNAMIC:
                ...
                if ((options.size_in_bytes > 0 && (options.size_in_bytes % MVHD_SECTOR_SIZE) > 0) || (options.size_in_bytes > MVHD_MAX_SIZE_IN_BYTES) || (options.size_in_bytes == 0 && geom_sector_size == 0)) {
