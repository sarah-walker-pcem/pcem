        ...
        if (!(addr & 1))
                ...
                case AIP_SACFG1:
                        ...
                        if (aip.regs[AIP_SACFG1] & SxCFG1_ENA) {
                                ...
                                case SxCFG1_ADDR_3F8:
                                        base = 0x3f8;
                                        break;
                                case SxCFG1_ADDR_2F8:
                                        base = 0x2f8;
                                        break;
                                case SxCFG1_ADDR_220:
                                        base = 0x220;
                                        break;
                                case SxCFG1_ADDR_228:
                                        base = 0x228;
                                        break;
                                case SxCFG1_ADDR_238:
                                        base = 0x238;
                                        break;
                                case SxCFG1_ADDR_2E8:
                                        base = 0x2e8;
                                        break;
                                case SxCFG1_ADDR_338:
                                        base = 0x338;
                                        break;
                                case SxCFG1_ADDR_3E8:
                                        base = 0x3e8;
                                        break;
                                }
