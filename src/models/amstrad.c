...
mouse_t mouse_amstrad = {"Amstrad mouse", mouse_amstrad_init, mouse_amstrad_close, mouse_amstrad_poll, MOUSE_TYPE_AMSTRAD};
...
device_config_t ams1512_config[] = {{.name = "language",
                                     .description = "BIOS language",
                                     .type = CONFIG_SELECTION,
                                     .selection = {{.description = "English", .value = 7},
...
device_config_t ams2086_config[] = {{.name = "language",
                                     .description = "BIOS language",
                                     .type = CONFIG_SELECTION,
                                     .selection = {{.description = "English", .value = 7},
                                                   {.description = "Diagnostic mode", .value = 0},
...
device_config_t ams3086_config[] = {{.name = "language",
                                     .description = "BIOS language",
                                     .type = CONFIG_SELECTION,
                                     .selection = {{.description = "English", .value = 7},
...
device_t ams1512_device = {"Amstrad PC1512 (BIOS)", 0, ams1512_init, NULL, NULL, NULL, NULL, NULL, ams1512_config};

device_t ams2086_device = {"Amstrad PC2086 (BIOS)", 0, ams1512_init, NULL, NULL, NULL, NULL, NULL, ams2086_config};

device_t ams3086_device = {"Amstrad PC3086 (BIOS)", 0, ams1512_init, NULL, NULL, NULL, NULL, NULL, ams3086_config};
