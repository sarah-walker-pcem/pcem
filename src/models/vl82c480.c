...
//        if (addr != 0x92) pclog("vl82c480_write: addr=%04x val=%02x\n", addr, val);
	...
	case 0xec:vl82c480.cfg_index = val;
		break;
...
uint8_t vl82c480_read(uint16_t addr, void *p) {
	...
	switch (addr) {
	case 0x92:ret = vl82c480.port_92;
		break;

	case 0xec:ret = vl82c480.cfg_index;
		break;

	case 0xed:ret = vl82c480.cfg_regs[vl82c480.cfg_index];
		break;
