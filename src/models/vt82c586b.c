...
static void vt82c586b_pci_isa_bridge_write(int addr, uint8_t val) {
        /*Read-only addresses*/
        if ((addr < 4) || (addr == 5) || (addr == 6) || (addr >= 8 && addr < 0x40) || (addr == 0x49) || (addr == 0x4b) || (addr >= 0x51 && addr < 0x54) || (addr >= 0x5d && addr < 0x60) || (addr >= 0x68 && addr < 0x6a) || (addr >= 0x71))
                return;
...
static void vt82c586b_ide_write(int addr, uint8_t val) {
        /*Read-only addresses*/
        if ((addr < 4) || (addr == 5) || (addr == 8) || (addr >= 0xa && addr < 0x0d) || (addr >= 0x0e && addr < 0x20) || (addr >= 0x22 && addr < 0x3c) || (addr >= 0x3d && addr < 0x40) || (addr >= 0x54 && addr < 0x60) || (addr >= 0x52 && addr < 0x68) || (addr >= 0x62))
                return;
...
static void vt82c586b_usb_write(int addr, uint8_t val) {
        /*Read-only addresses*/
        if ((addr < 4) || (addr == 5) || (addr == 6) || (addr >= 8 && addr < 0xd) || (addr >= 0xe && addr < 0x20) || (addr >= 0x22 && addr < 0x3c) || (addr >= 0x3e && addr < 0x40) || (addr >= 0x42 && addr < 0x44) || (addr >= 0x46 && addr < 0xc0) || (addr >= 0xc2))
                return;
...
static void vt82c586b_power_write(int addr, uint8_t val) {
        /*Read-only addresses*/
        if ((addr < 0xd) || (addr >= 0xe && addr < 0x40) || (addr == 0x43) || (addr == 0x48) || (addr >= 0x4a && addr < 0x50) || (addr >= 0x54))
                return;
