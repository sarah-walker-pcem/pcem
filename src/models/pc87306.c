...
//                pclog("PC87306 write %02x %02x\n", pc87306->cur_addr, val);
		...
		if (pc87306->regs[REG_FER] & FER_COM1_ENA) {
			...
			case 0:
			case 2:serial1_set(addr, 4);
				break;
			case 1:
			case 3:serial1_set(addr, 3);
				break;
			}
		}
		serial2_remove();
		if (pc87306->regs[REG_FER] & FER_COM2_ENA) {
			...
			case 0:
			case 2:serial2_set(addr, 4);
				break;
			case 1:
			case 3:serial2_set(addr, 3);
				break;
			}
		}
		lpt1_remove();
		...
		if (pc87306->regs[REG_FER] & FER_LPT_ENA) {
			...
			case 0x5:
			case 0x6:
			case 0x7:lpt1_init(0x378);
				break;
			case 0x1:
			case 0x9:lpt1_init(0x3bc);
				break;
			case 0x2:
			case 0xa:
			case 0xc:
