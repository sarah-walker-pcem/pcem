...
//        pclog("mach64 out %04X %02X\n", addr, val);
        ...
        switch (addr)
        {
                ...
                if (svga->gdcaddr == 6)
                {
                        ...
                        {
                                mem_removehandler(0xa0000, 0x20000, mach64_read, NULL, NULL, mach64_write, NULL, NULL,  mach64);
...
void mach64_recalctimings(svga_t *svga)
{
        ...
        if (((mach64->crtc_gen_cntl >> 24) & 3) == 3)
        {
                ...
                svga->ma = (mach64->crtc_off_pitch & 0x1fffff) * 2;
