...
//        if (addr > 0x389) pclog("adgold_write : addr %04X val %02X %04X:%04X\n", addr, val, CS, pc);
	switch (addr & 7) {
	case 0:
	case 1:opl3_write(addr, val, &adgold->opl);
		break;
	...
	case 3:
		if (adgold->adgold_38x_state) {
			...
			default:adgold->adgold_38x_regs[adgold->adgold_38x_addr] = val;
				break;
			}
		} else
			opl3_write(addr, val, &adgold->opl);
		break;
	case 4:
	case 6:adgold->adgold_mma_addr = val;
		break;
	case 5:
		if (adgold->adgold_mma_addr >= 0xf)
			break;
		switch (adgold->adgold_mma_addr) {
		case 0x2:adgold->adgold_mma.timer0_latch = (adgold->adgold_mma.timer0_latch & 0xff00) | val;
			break;
		case 0x3:adgold->adgold_mma.timer0_latch = (adgold->adgold_mma.timer0_latch & 0xff) | (val << 8);
			break;
		case 0x4:adgold->adgold_mma.timerbase_latch = (adgold->adgold_mma.timerbase_latch & 0xf00) | val;
			break;
		case 0x5:adgold->adgold_mma.timerbase_latch = (adgold->adgold_mma.timerbase_latch & 0xff) | ((val & 0xf) << 8);
			adgold->adgold_mma.timer1_latch = val >> 4;
			break;
		case 0x6:adgold->adgold_mma.timer2_latch = (adgold->adgold_mma.timer2_latch & 0xff00) | val;
			break;
		case 0x7:adgold->adgold_mma.timer2_latch = (adgold->adgold_mma.timer2_latch & 0xff) | (val << 8);
			break;
		...
		case 0x9:
			switch (val & 0x18) {
			case 0x00:adgold->adgold_mma.voice_latch[0] = 12;
				break; /*44100 Hz*/
			case 0x08:adgold->adgold_mma.voice_latch[0] = 24;
				break; /*22050 Hz*/
			case 0x10:adgold->adgold_mma.voice_latch[0] = 48;
				break; /*11025 Hz*/
			case 0x18:adgold->adgold_mma.voice_latch[0] = 72;
				break; /* 7350 Hz*/
			}
			if (val & 0x80) {
...
//                                pclog("adgold end\n");
		...
		case 0xc:adgold->adgold_mma_intpos[0] = (7 - ((val >> 2) & 7)) * 8;
			break;
		}
	...
	case 7:
		if (adgold->adgold_mma_addr >= 0xf)
			break;
		switch (adgold->adgold_mma_addr) {
		case 0x9:adgold_update(adgold);
			switch (val & 0x18) {
			case 0x00:adgold->adgold_mma.voice_latch[1] = 12;
				break; /*44100 Hz*/
			case 0x08:adgold->adgold_mma.voice_latch[1] = 24;
				break; /*22050 Hz*/
			case 0x10:adgold->adgold_mma.voice_latch[1] = 48;
				break; /*11025 Hz*/
			case 0x18:adgold->adgold_mma.voice_latch[1] = 72;
				break; /* 7350 Hz*/
			}
			if (val & 0x80) {
...
//                                pclog("adgold end\n");
		...
		case 0xc:adgold->adgold_mma_intpos[1] = (7 - ((val >> 2) & 7)) * 8;
			break;
		}
...
uint8_t adgold_read(uint16_t addr, void *p) {
	...
	switch (addr & 7) {
	case 0:
	case 1:temp = opl3_read(addr, &adgold->opl);
		break;
	...
	case 3:
		if (adgold->adgold_38x_state) {
			...
			default:temp = adgold->adgold_38x_regs[adgold->adgold_38x_addr];
			}
		} else
			temp = opl3_read(addr, &adgold->opl);
		break;
	...
	case 4:
	case 6:temp = adgold->adgold_mma_status;
	...
	case 5:
		...
		default:temp = adgold->adgold_mma_regs[0][adgold->adgold_mma_addr];
			break;
		}
		break;
	case 7:
