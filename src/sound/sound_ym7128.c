...
#define GET_DELAY_SAMPLE(ym7128, offset)                                                                                         \
        (((ym7128->delay_pos - offset) < 0) ? ym7128->delay_buffer[(ym7128->delay_pos - offset) + 2400]                          \
                                            : ym7128->delay_buffer[ym7128->delay_pos - offset])
...
void ym7128_apply(ym7128_t *ym7128, int16_t *buffer, int len) {
        ...
        for (c = 0; c < len * 2; c += 4) {
                ...
                int32_t samp =
                        ((int32_t)buffer[c] + (int32_t)buffer[c + 1] + (int32_t)buffer[c + 2] + (int32_t)buffer[c + 3]) / 4;
