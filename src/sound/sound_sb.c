...
static void sb_get_buffer_sb16(int32_t *buffer, int len, void *p) {
        ...
        for (c = 0; c < len * 2; c += 2) {
                ...
                in_l = (mixer->input_selector_left & INPUT_MIDI_L) ? out_l : 0 + (mixer->input_selector_left & INPUT_MIDI_R) ? out_r
                                                                                                                             : 0;
                in_r = (mixer->input_selector_right & INPUT_MIDI_L) ? out_l : 0 + (mixer->input_selector_right & INPUT_MIDI_R) ? out_r
                                                                                                                               : 0;
