        ...
        case WX_COMMAND: {
                if (wParam == WX_ID("IDC_COMBO1")) {
                        ...
                        if (!(cpu_flags & CPU_SUPPORTS_DYNAREC) || (cpu_flags & CPU_REQUIRES_DYNAREC))
                                ...
                                wx_enablewindow(h, TRUE);
                        wx_sendmessage(h, WX_BM_SETCHECK,
                                       ((cpu_flags & CPU_SUPPORTS_DYNAREC) && temp_dynarec) || (cpu_flags & CPU_REQUIRES_DYNAREC), 0);
                        ...
                        wx_sendmessage(h, WX_UDM_SETRANGE, 0,
                                       (models[temp_model]->min_ram << 16) | models[temp_model]->max_ram);
                        mem &= ~(models[temp_model]->ram_granularity - 1);
                        if (mem < models[temp_model]->min_ram)
                                mem = models[temp_model]->min_ram;
                        else if (mem > models[temp_model]->max_ram)
...
static struct
{
    ...
    {
        {306, 4}, {615, 4}, {615, 6}, {940, 8}, {940, 6}, {615, 4}, {462, 8}, {733, 5}, {900, 15}, {820, 3}, {855, 5}, {855, 7}, {306, 8}, {733, 7}, {0, 0}, {612, 4}, {977, 5}, {977, 7}, {1024, 7}, {733, 5}, {733, 7}, {733, 5}, {306, 4}, {925, 7}, {925, 9}, {754, 7}, {754, 11}, {699, 7}, {823, 10}, {918, 7}, {1024, 11}, {1024, 15}, {1024, 5}, {612, 2}, {1024, 9}, {1024, 8}, {615, 8}, {987, 3}, {462, 7}, {820, 6}, {977, 5}, {981, 5}, {830, 7}, {830, 10}, {917, 15}, {1224, 15}};
