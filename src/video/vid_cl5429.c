...
//        pclog("gd5429 out %04X %02X\n", addr, val);
	...
	case 0x3c5:
		if (svga->seqaddr > 5) {
			...
			case 0xb0:
			case 0xd0:
			case 0xf0:svga->hwcursor.x = (val << 3) | ((svga->seqaddr >> 5) & 7);
...
//                                pclog("svga->hwcursor.x = %i\n", svga->hwcursor.x);
			...
			case 0xb1:
			case 0xd1:
			case 0xf1:svga->hwcursor.y = (val << 3) | ((svga->seqaddr >> 5) & 7);
				gd5429->sr11_read = svga->seqaddr & 0xe0;
//                                pclog("svga->hwcursor.y = %i\n", svga->hwcursor.y);
				break;
			case 0x12:svga->hwcursor.ena = val & 1;
...
//                                pclog("svga->hwcursor.addr = %x\n", svga->hwcursor.addr);
			...
			case 0x07:svga->set_reset_disabled = svga->seqregs[7] & 1;
...
//                pclog("CL write 3c6 %02x %i\n", val, gd5429->dac_3c6_count);
	...
	case 0x3c7:
	case 0x3c8:
	case 0x3c9:gd5429->dac_3c6_count = 0;
		break;
...
//                        pclog("writemode = %i\n", svga->writemode);
		...
		if (svga->gdcaddr > 8) {
			...
			case 0x09:
			case 0x0a:
			case 0x0b:gd5429_recalc_banking(gd5429);
				if (svga->gdcreg[0xb] & 0x04)
					svga->writemode = svga->gdcreg[5] & 7;
				else
					svga->writemode = svga->gdcreg[5] & 3;
			...
			case 0x10:gd5429_mmio_write(0xb8001, val, gd5429);
				break;
			case 0x11:gd5429_mmio_write(0xb8005, val, gd5429);
				break;
			case 0x12:gd5429_mmio_write(0xb8002, val, gd5429);
				break;
			case 0x13:gd5429_mmio_write(0xb8006, val, gd5429);
				break;
			case 0x14:gd5429_mmio_write(0xb8003, val, gd5429);
				break;
			case 0x15:gd5429_mmio_write(0xb8007, val, gd5429);
				break;

			case 0x20:gd5429_mmio_write(0xb8008, val, gd5429);
				break;
			case 0x21:gd5429_mmio_write(0xb8009, val, gd5429);
				break;
			case 0x22:gd5429_mmio_write(0xb800a, val, gd5429);
				break;
			case 0x23:gd5429_mmio_write(0xb800b, val, gd5429);
				break;
			case 0x24:gd5429_mmio_write(0xb800c, val, gd5429);
				break;
			case 0x25:gd5429_mmio_write(0xb800d, val, gd5429);
				break;
			case 0x26:gd5429_mmio_write(0xb800e, val, gd5429);
				break;
			case 0x27:gd5429_mmio_write(0xb800f, val, gd5429);
				break;

			case 0x28:gd5429_mmio_write(0xb8010, val, gd5429);
				break;
			case 0x29:gd5429_mmio_write(0xb8011, val, gd5429);
				break;
			case 0x2a:gd5429_mmio_write(0xb8012, val, gd5429);
				break;

			case 0x2c:gd5429_mmio_write(0xb8014, val, gd5429);
				break;
			case 0x2d:gd5429_mmio_write(0xb8015, val, gd5429);
				break;
			case 0x2e:gd5429_mmio_write(0xb8016, val, gd5429);
				break;

			case 0x2f:gd5429_mmio_write(0xb8017, val, gd5429);
				break;
			case 0x30:gd5429_mmio_write(0xb8018, val, gd5429);
				break;

			case 0x32:gd5429_mmio_write(0xb801a, val, gd5429);
				break;

			case 0x31:gd5429_mmio_write(0xb8040, val, gd5429);
				break;
...
//        if (addr != 0x3da) pclog("IN gd5429 %04X\n", addr);
	...
	case 0x3c5:
		if (svga->seqaddr > 5) {
			...
			switch (svga->seqaddr) {
			case 6:return ((svga->seqregs[6] & 0x17) == 0x12) ? 0x12 : 0x0f;
...
//                pclog("CL read 3c6 %i\n", gd5429->dac_3c6_count);
	...
	case 0x3D5:
		...
		case 0x27: /*ID*/
			switch (gd5429->type) {
			case CL_TYPE_AVGA2:return 0x18; /*AVGA2*/
			case CL_TYPE_GD5426:return 0x90; /*GD5426*/
			case CL_TYPE_GD5428:return 0x98; /*GD5428*/
			case CL_TYPE_GD5429:return 0x9c; /*GD5429*/
			case CL_TYPE_GD5430:return 0xa0; /*GD5430*/
			case CL_TYPE_GD5434:return 0xa8; /*GD5434*/
			}
			break;
		case 0x28: /*Class ID*/
...
//        pclog("MA now %05X %02X\n", svga->ma_latch, svga->crtc[0x1b]);
	...
	if (gd5429->hidden_dac_reg & 0x80) {
		if (gd5429->hidden_dac_reg & 0x40) {
			...
			case 0x0:svga->render = svga_render_15bpp_highres;
				svga->bpp = 15;
				break;
			case 0x1:svga->render = svga_render_16bpp_highres;
				svga->bpp = 16;
				break;
			case 0x5:
...
void gd5429_start_blit(uint32_t cpu_dat, int count, void *p) {
	...
	case BLIT_DEPTH_8:x_max = 8;
		break;
	case BLIT_DEPTH_16:x_max = 16;
		blt_mask *= 2;
		break;
	case BLIT_DEPTH_32:x_max = 32;
		blt_mask *= 4;
		break;
	}
...
//                        pclog("blt.mode & 0x04\n");
			...
			if (!(svga->seqregs[7] & 0xf0))
				...
				mem_mapping_set_handler(&gd5429->linear_mapping,
							gd5429_readb_linear,
							gd5429_readw_linear,
							gd5429_readl_linear,
							gd5429_writeb_linear,
							gd5429_writew_linear,
	...
	while (count) {
		...
		if (gd5429->blt.mode & 0x04) {
			if (gd5429->blt.mode & 0x80) {
				...
				switch (gd5429->blt.depth) {
				case BLIT_DEPTH_8:src = mask ? gd5429->blt.fg_col : gd5429->blt.bg_col;
					cpu_dat <<= 1;
					count--;
					break;
				case BLIT_DEPTH_16:src = mask ? (gd5429->blt.fg_col >> shift) : (gd5429->blt.bg_col >> shift);
					if (gd5429->blt.x_count & 1) {
						cpu_dat <<= 1;
						count--;
					}
					break;
				case BLIT_DEPTH_32:src = mask ? (gd5429->blt.fg_col >> shift) : (gd5429->blt.bg_col >> shift);
			...
			case 0x00:src = svga->vram[gd5429->blt.src_addr & svga->vram_mask];
				gd5429->blt.src_addr += ((gd5429->blt.mode & 0x01) ? -1 : 1);
				mask = 1;
				break;
			case 0x40:
				switch (gd5429->blt.depth) {
				case BLIT_DEPTH_8:src = svga->vram[(gd5429->blt.src_addr & (svga->vram_mask & ~7)) + (gd5429->blt.y_count << 3) + (gd5429->blt.x_count & 7)];
					break;
				case BLIT_DEPTH_16:src = svga->vram[(gd5429->blt.src_addr & (svga->vram_mask & ~3)) + (gd5429->blt.y_count << 4) + (gd5429->blt.x_count & 15)];
					break;
				case BLIT_DEPTH_32:src = svga->vram[(gd5429->blt.src_addr & (svga->vram_mask & ~3)) + (gd5429->blt.y_count << 5) + (gd5429->blt.x_count & 31)];
					break;
				}
				mask = 1;
				break;
			case 0x80:
				switch (gd5429->blt.depth) {
				case BLIT_DEPTH_8:mask = svga->vram[gd5429->blt.src_addr & svga->vram_mask] & (0x80 >> gd5429->blt.x_count);
					src = mask ? gd5429->blt.fg_col : gd5429->blt.bg_col;
					break;
				case BLIT_DEPTH_16:mask = svga->vram[gd5429->blt.src_addr & svga->vram_mask] & (0x80 >> (gd5429->blt.x_count >> 1));
					src = mask ? (gd5429->blt.fg_col >> shift) : (gd5429->blt.bg_col >> shift);
					break;
				case BLIT_DEPTH_32:mask = svga->vram[gd5429->blt.src_addr & svga->vram_mask] & (0x80 >> (gd5429->blt.x_count >> 2));
					src = mask ? (gd5429->blt.fg_col >> shift) : (gd5429->blt.bg_col >> shift);
					break;
				}
				break;
			case 0xc0:
				switch (gd5429->blt.depth) {
				case BLIT_DEPTH_8:mask = svga->vram[(gd5429->blt.src_addr & svga->vram_mask & ~7) | gd5429->blt.y_count] & (0x80 >> gd5429->blt.x_count);
					src = mask ? gd5429->blt.fg_col : gd5429->blt.bg_col;
					break;
				case BLIT_DEPTH_16:mask = svga->vram[(gd5429->blt.src_addr & svga->vram_mask & ~7) | gd5429->blt.y_count] & (0x80 >> (gd5429->blt.x_count >> 1));
					src = mask ? (gd5429->blt.fg_col >> shift) : (gd5429->blt.bg_col >> shift);
					break;
				case BLIT_DEPTH_32:mask = svga->vram[(gd5429->blt.src_addr & svga->vram_mask & ~7) | gd5429->blt.y_count] & (0x80 >> (gd5429->blt.x_count >> 2));
					src = mask ? (gd5429->blt.fg_col >> shift) : (gd5429->blt.bg_col >> shift);
					break;
				}
				break;
...
//                pclog("Blit %i,%i %06X %06X  %06X %02X %02X  %02X %02X ", gd5429->blt.width, gd5429->blt.height_internal, gd5429->blt.src_addr, gd5429->blt.dst_addr, gd5429->blt.src_addr & svga->vram_mask, svga->vram[gd5429->blt.src_addr & svga->vram_mask], 0x80 >> (gd5429->blt.dst_addr & 7), src, dst);
		...
		case 0x00:dst = 0;
			break;
		case 0x05:dst = src & dst;
			break;
		case 0x06:dst = dst;
			break;
		case 0x09:dst = src & ~dst;
			break;
		case 0x0b:dst = ~dst;
			break;
		case 0x0d:dst = src;
		...
		case 0x0e:dst = 0xff;
			break;
		case 0x50:dst = ~src & dst;
			break;
		case 0x59:dst = src ^ dst;
			break;
		case 0x6d:dst = src | dst;
			break;
		case 0x90:dst = ~(src | dst);
			break;
		case 0x95:dst = ~(src ^ dst);
			break;
		case 0xad:dst = src | ~dst;
			break;
		case 0xd0:dst = ~src;
			break;
		case 0xd6:dst = ~src | dst;
			break;
		case 0xda:dst = ~(src & dst);
			break;
		}
		//pclog("%02X  %02X\n", dst, mask);
		...
		if (gd5429->blt.width == 0xffff) {
			...
			switch (gd5429->blt.mode & 0xc0) {
			case 0x00:gd5429->blt.src_addr = gd5429->blt.src_addr_backup = gd5429->blt.src_addr_backup + ((gd5429->blt.mode & 0x01) ? -gd5429->blt.src_pitch : gd5429->blt.src_pitch);
				break;
			case 0x80:
...
static void gd5429_mmio_write(uint32_t addr, uint8_t val, void *p) {
	...
	if ((addr & ~0xff) == 0xb8000) {
		...
		case 0x08:gd5429->blt.width = (gd5429->blt.width & 0xff00) | val;
			break;
		case 0x09:gd5429->blt.width = (gd5429->blt.width & 0x00ff) | (val << 8);
			if (gd5429->type >= CL_TYPE_GD5434)
				gd5429->blt.width &= 0x1fff;
			else
				gd5429->blt.width &= 0x07ff;
			break;
		case 0x0a:gd5429->blt.height = (gd5429->blt.height & 0xff00) | val;
			break;
		case 0x0b:gd5429->blt.height = (gd5429->blt.height & 0x00ff) | (val << 8);
			gd5429->blt.height &= 0x03ff;
			break;
		case 0x0c:gd5429->blt.dst_pitch = (gd5429->blt.dst_pitch & 0xff00) | val;
			break;
		case 0x0d:gd5429->blt.dst_pitch = (gd5429->blt.dst_pitch & 0x00ff) | (val << 8);
			break;
		case 0x0e:gd5429->blt.src_pitch = (gd5429->blt.src_pitch & 0xff00) | val;
			break;
		case 0x0f:gd5429->blt.src_pitch = (gd5429->blt.src_pitch & 0x00ff) | (val << 8);
			break;

		case 0x10:gd5429->blt.dst_addr = (gd5429->blt.dst_addr & 0xffff00) | val;
			break;
		case 0x11:gd5429->blt.dst_addr = (gd5429->blt.dst_addr & 0xff00ff) | (val << 8);
			break;
		case 0x12:gd5429->blt.dst_addr = (gd5429->blt.dst_addr & 0x00ffff) | (val << 16);
			if (gd5429->type >= CL_TYPE_GD5434)
		...
		case 0x14:gd5429->blt.src_addr = (gd5429->blt.src_addr & 0xffff00) | val;
			break;
		case 0x15:gd5429->blt.src_addr = (gd5429->blt.src_addr & 0xff00ff) | (val << 8);
			break;
		case 0x16:gd5429->blt.src_addr = (gd5429->blt.src_addr & 0x00ffff) | (val << 16);
			if (gd5429->type >= CL_TYPE_GD5434)
		...
		case 0x17:gd5429->blt.mask = val;
			break;
		case 0x18:gd5429->blt.mode = val;
			if (gd5429->type >= CL_TYPE_GD5434)
...
//        pclog("CL PCI read %08X\n", addr);
	...
	case 0x02:
		switch (gd5429->type) {
		case CL_TYPE_GD5430:return 0xa0;
		case CL_TYPE_GD5434:return 0xa8;
		}
		return 0xff;
	case 0x03:return 0x00;

	case PCI_REG_COMMAND:return gd5429->pci_regs[PCI_REG_COMMAND]; /*Respond to IO and memory accesses*/
...
//        pclog("cl_pci_write: addr=%02x val=%02x\n", addr, val);
	switch (addr) {
	case PCI_REG_COMMAND:gd5429->pci_regs[PCI_REG_COMMAND] = val & 0x23;
	...
	case 0x13:gd5429->lfb_base = val << 24;
		gd5429_recalc_mapping(gd5429);
		break;

	case 0x30:
	case 0x32:
	case 0x33:gd5429->pci_regs[addr] = val;
...
static void *cl_init(int type, char *fn, int pci_card, uint32_t force_vram_size) {
	...
	mem_mapping_add(&gd5429->linear_mapping,
			0,
			0,
			gd5429_readb_linear,
			gd5429_readw_linear,
