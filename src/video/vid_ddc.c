...
enum { TRANSMITTER_MONITOR = 1, TRANSMITTER_HOST = -1 };
...
enum { PROM_IDLE = 0, PROM_RECEIVEADDR, PROM_RECEIVEDATA, PROM_SENDDATA, PROM_INVALID };
...
int ddc_read_clock(void) { return i2c.clock; }
