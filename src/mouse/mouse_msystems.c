...
mouse_t mouse_serial_msystems = {"Mouse Systems 3-button mouse (serial)", mouse_msystems_init, mouse_msystems_close,
                                 mouse_msystems_poll, MOUSE_TYPE_SERIAL | MOUSE_TYPE_3BUTTON};
