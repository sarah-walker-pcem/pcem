...
#define ROP_PUSH_SEG(seg)                                                                                                        \
        uint32_t ropPUSH_##seg##_16(codeblock_t *block, ir_data_t *ir, uint8_t opcode, uint32_t fetchdat, uint32_t op_32,        \
                                    uint32_t op_pc) {                                                                            \
                int sp_reg;                                                                                                      \
                                                                                                                                 \
                uop_MOV_IMM(ir, IREG_oldpc, cpu_state.oldpc);                                                                    \
        ...
        uint32_t ropPUSH_##seg##_32(codeblock_t *block, ir_data_t *ir, uint8_t opcode, uint32_t fetchdat, uint32_t op_32,        \
                                    uint32_t op_pc) {                                                                            \
                int sp_reg;                                                                                                      \
                                                                                                                                 \
                uop_MOV_IMM(ir, IREG_oldpc, cpu_state.oldpc);                                                                    \
...
#define ROP_POP_SEG(seg, rseg)                                                                                                   \
        uint32_t ropPOP_##seg##_16(codeblock_t *block, ir_data_t *ir, uint8_t opcode, uint32_t fetchdat, uint32_t op_32,         \
                                   uint32_t op_pc) {                                                                             \
                uop_MOV_IMM(ir, IREG_oldpc, cpu_state.oldpc);                                                                    \
                                                                                                                                 \
                if (stack32)                                                                                                     \
        ...
        uint32_t ropPOP_##seg##_32(codeblock_t *block, ir_data_t *ir, uint8_t opcode, uint32_t fetchdat, uint32_t op_32,         \
                                   uint32_t op_pc) {                                                                             \
                uop_MOV_IMM(ir, IREG_oldpc, cpu_state.oldpc);                                                                    \
                                                                                                                                 \
                if (stack32)                                                                                                     \
