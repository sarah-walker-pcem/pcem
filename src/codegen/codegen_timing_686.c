...
//                        pclog("timings 80 %p %p %p\n", (void *)timings, (void *)opcode_timings_mod3, (void *)opcode_timings_8x);
		...
		case 0xc0:
		case 0xc1:timings = mod3 ? opcode_timings_shift_imm_mod3 : opcode_timings_shift_imm;
...
//                        pclog("timings d0\n");
		...
		case 0xd2:
		case 0xd3:timings = mod3 ? opcode_timings_shift_cl_mod3 : opcode_timings_shift_cl;
